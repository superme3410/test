...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'stack.superhai.ccwu.cc';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNDkyYzc5OTQ5NDM2MmZjODZkNTUxYjUyMDQ2NTMyOGMiLCJ0IjoiMDdhYTlmMTEtNmJmNS00YTNjLThkNmQtZjYwYmM3MmU3NGExIiwicyI6IllUQXdOVEkzWmpZdE1EWTBOQzAwTWpsaExXSmpOekl0WXpkbU1EWXhZV1EyTlROaiJ9';               // argo固定隧道token或json,留空即使用临时隧道
...
const TUIC_PORT = process.env.TUIC_PORT || '65121';               // tuic端口，支持多端口的可以填写，否则留空
const HY2_PORT = process.env.HY2_PORT || '8001';                 // hy2端口，支持多端口的可以填写，否则留空
const ANYTLS_PORT = process.env.ANYTLS_PORT || '65122';           // AnyTLS端口，支持多端口的可以填写，否则留空
